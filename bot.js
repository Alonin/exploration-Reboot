            ...
            if (basicLock.beginnerLock === 0) {
                ...
                request.post({
                    ...
                    if (error) {
                        ...
                        // Use the URL of the uploaded image as desired
                        let imgurlink = data.data.link;
                        console.log(`Retail Basic Challenge uploaded to Imgur: ${data.data.link}`);
                        ...
                        const challengeEmbed = new EmbedBuilder()
                            ...
                            .setTimestamp()
                        message.reply({ embeds: [challengeEmbed] });
                        message.channel.send(`<@${message.user.id}> Has set a basic challenge! Solve this challenge by posting a picture of your character in the same place, and earn 3 points!`)
            ...
            if (basicLock.advanceLock === 0) {
                ...
                request.post({
                    ...
                    if (error) {
                        ...
                        // Use the URL of the uploaded image as desired
                        let imgurlink = data.data.link;
                        console.log(`Retail Advanced Challenge uploaded to Imgur: ${data.data.link}`);
                        //  message.reply({ embeds: [challengeEmbed] });
                        //  message.reply(imgurlink);
                        const challengeEmbed = new EmbedBuilder()
                            .setTitle('Advanced Challenge')
                            ...
                            .setTimestamp()
                        message.reply({ embeds: [challengeEmbed] });
                        message.channel.send(`<@${message.user.id}> Has set an advanced challenge! Solve this challenge by posting a picture of your character in the same place, and earn 5 points!`)
            ...
            if (basicLock.extremeLock === 0) {
                ...
                request.post({
                    ...
                    if (error) {
                        ...
                        // Use the URL of the uploaded image as desired
                        let imgurlink = data.data.link;
                        console.log(`Retail Extreme Challenge uploaded to Imgur: ${data.data.link}`);
                        //  message.reply({ embeds: [challengeEmbed] });
                        //  message.reply(imgurlink);
                        const challengeEmbed = new EmbedBuilder()
                            .setTitle('Extreme Challenge')
                            ...
                            .setTimestamp()
                        message.reply({ embeds: [challengeEmbed] });
                        message.channel.send(`<@${message.user.id}> Has set an extreme challenge! Solve this challenge by posting a picture of your character in the same place, and earn 5 points + 5 more for every week the challenge stays up! (Max 20 points)`)
                ...
                if (basicLock.ClassicBasicLock === 0) {
                    ...
                    request.post({
                        ...
                        if (error) {
                            ...
                            // Use the URL of the uploaded image as desired
                            let imgurlink = data.data.link;
                            console.log(`WoTLK Basic Challenge uploaded to Imgur: ${data.data.link}`);
                            //  message.reply({ embeds: [challengeEmbed] });
                            //  message.reply(imgurlink);
                            const challengeEmbed = new EmbedBuilder()
                                .setTitle('WotLK Basic Challenge')
                                ...
                                .setTimestamp()
                            message.reply({ embeds: [challengeEmbed] });
                            message.channel.send(`<@${message.user.id}> Has set a WOTLK basic challenge! Solve this challenge by posting a picture of your character in the same place, and earn 3 points!`)
                ...
                if (basicLock.ClassicLock === 0) {
                    ...
                    request.post({
                        ...
                        if (error) {
                            ...
                            // Use the URL of the uploaded image as desired
                            let imgurlink = data.data.link;
                            console.log(`WotLK Advanced Challenge uploaded to Imgur: ${data.data.link}`);
                            //  message.reply({ embeds: [challengeEmbed] });
                            //  message.reply(imgurlink);
                            const challengeEmbed = new EmbedBuilder()
                                .setTitle('WotLK Advanced Challenge')
                                ...
                                .setTimestamp()
                            message.reply({ embeds: [challengeEmbed] });
                            message.channel.send(`<@${message.user.id}> Has set a wotlk advanced challenge! Solve this challenge by posting a picture of your character in the same place, and earn 5 points!`)
                ...
                if (basicLock.classicExtremeLock === 0) {
                    ...
                    request.post({
                        ...
                        if (error) {
                            ...
                            // Use the URL of the uploaded image as desired
                            let imgurlink = data.data.link;
                            console.log(`WotLK Extreme Challenge uploaded to Imgur: ${data.data.link}`);
                            //  message.reply({ embeds: [challengeEmbed] });
                            //  message.reply(imgurlink);
                            const challengeEmbed = new EmbedBuilder()
                                .setTitle('WotLK Extreme Challenge')
                                ...
                                .setTimestamp()
                            message.reply({ embeds: [challengeEmbed] });
                            message.channel.send(`<@${message.user.id}> Has set a WOTLK extreme challenge! Solve this challenge by posting a picture of your character in the same place, and earn 5 points + 5 more for every week the challenge stays up! (Max 20 points)`)
            ...
            if (basicSolve.beginnerLock === 1 && basicSolve.isVerifyBeginner === 0 && message.user.id !== basicSolve.setBeginnerId) {
                ...
                request.post({
                    ...
                    if (error) {
                        ...
                        // Use the URL of the uploaded image as desired
                        let imgurlink = data.data.link;
                        console.log(`Retail Basic Solve uploaded to Imgur: ${data.data.link}`);
                        //  message.reply({ embeds: [challengeEmbed] });
                        //  message.reply(imgurlink);
                        const challengeSolveEmbed = new EmbedBuilder()
                            ...
                            .setImage(imgurlink)
                            .setTimestamp()
                        message.reply({ embeds: [challengeSolveEmbed] });


                    }
                    message.channel.send({ content: `A challenger has solved this challenge <@${basicSolve.setBeginnerId}> or an Admin will need to verify it is correct by clicking the accept or decline buttons below.`, components: [basic_buttons] });
            ...
            if (basicSolve.advanceLock === 1 && basicSolve.isVerifyAdvance === 0 && message.user.id !== basicSolve.setAdvanceId) {
                ...
                request.post({
                    ...
                    if (error) {
                        ...
                        // Use the URL of the uploaded image as desired
                        let imgurlink = data.data.link;
                        console.log(`Retail Advanced Solve uploaded to Imgur: ${data.data.link}`);
                        //  message.reply({ embeds: [challengeEmbed] });
                        //  message.reply(imgurlink);
                        const challengeSolveEmbed = new EmbedBuilder()
                            .setTitle('Advanced Solve')
                    ...
                    message.channel.send({ content: `A challenger has solved this challenge <@${basicSolve.setAdvanceId}> or an Admin will need to verify it is correct by clicking the accept or decline buttons below.`, components: [advanced_buttons_retail] });
            ...
            if (basicSolve.extremeLock === 1 && basicSolve.isVerifyExtreme === 0 && message.user.id !== basicSolve.setExtremeId) {
                ...
                request.post({
                    ...
                    if (error) {
                        ...
                        // Use the URL of the uploaded image as desired
                        let imgurlink = data.data.link;
                        console.log(`Retail Extreme Solve uploaded to Imgur: ${data.data.link}`);
                        //  message.reply({ embeds: [challengeEmbed] });
                        //  message.reply(imgurlink);
                        const challengeSolveEmbed = new EmbedBuilder()
                            .setTitle('Extreme Solve')
                    ...
                    message.channel.send({ content: `A challenger has solved this challenge <@${basicSolve.setExtremeId}> or an Admin will need to verify it is correct by clicking the accept or decline buttons below.`, components: [extreme_buttons_retail] });
                ...
                if (basicSolve.ClassicBasicLock === 1 && basicSolve.isVerifyClassicBasic === 0 && message.user.id !== basicSolve.setClassicBasicId) {
                    ...
                    request.post({
                        ...
                        if (error) {
                            ...
                            // Use the URL of the uploaded image as desired
                            let imgurlink = data.data.link;
                            console.log(`Classic Basic Solve uploaded to Imgur: ${data.data.link}`);
                            //  message.reply({ embeds: [challengeEmbed] });
                            //  message.reply(imgurlink);
                            const challengeSolveEmbed = new EmbedBuilder()
                                .setTitle('WotLK Basic Solve')
                        ...
                        message.channel.send({ content: `A challenger has solved this challenge <@${basicSolve.setClassicBasicId}> or an Admin will need to verify it is correct by clicking the accept or decline buttons below.`, components: [basic_buttons_classic] });
                ...
                if (basicSolve.ClassicLock === 1 && basicSolve.isVerifyClassic === 0 && message.user.id !== basicSolve.setClassicId) {
                    ...
                    request.post({
                        ...
                        if (error) {
                            ...
                            // Use the URL of the uploaded image as desired
                            let imgurlink = data.data.link;
                            console.log(`Classic Advanced Solve uploaded to Imgur: ${data.data.link}`);
                            //  message.reply({ embeds: [challengeEmbed] });
                            //  message.reply(imgurlink);
                            const challengeSolveEmbed = new EmbedBuilder()
                                .setTitle('WotLK Advanced Solve')
                        ...
                        message.channel.send({ content: `A challenger has solved this challenge <@${basicSolve.setClassicId}> or an Admin will need to verify it is correct by clicking the accept or decline buttons below.`, components: [advanced_buttons_classic] });
                ...
                if (basicSolve.classicExtremeLock === 1 && basicSolve.isVerifyClassicExtreme === 0 && message.user.id !== basicSolve.setClassicExtremeId) {
                    ...
                    request.post({
                        ...
                        if (error) {
                            ...
                            // Use the URL of the uploaded image as desired
                            let imgurlink = data.data.link;
                            console.log(`Classic Extreme Solve uploaded to Imgur: ${data.data.link}`);
                            //  message.reply({ embeds: [challengeEmbed] });
                            //  message.reply(imgurlink);
                            const challengeSolveEmbed = new EmbedBuilder()
                                .setTitle('WotLK Extreme Solve')
                        ...
                        message.channel.send({ content: `A challenger has solved this challenge <@${basicSolve.setClassicExtremeId}> or an Admin will need to verify it is correct by clicking the accept or decline buttons below.`, components: [extreme_buttons_classic] });
